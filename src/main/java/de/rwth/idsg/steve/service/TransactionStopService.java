...
import de.rwth.idsg.steve.custom.FaultCode;
...
public class TransactionStopService {
    ...
    public void stop(Integer transactionPk) {
        ...
        String stopCode = DataTransferParams.LATEST_DATA != null ? DataTransferParams.LATEST_DATA.getCode() : "0";
        FaultCode code = FaultCode.getByID(stopCode);
